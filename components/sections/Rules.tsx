...
export default function Rules() {
    return (
        <section id="rules" className="relative py-32 px-4 container mx-auto z-10">
            ...
            >
                <div className="flex items-start gap-3 p-5 rounded-2xl bg-yellow-500/5 border border-yellow-500/20">
                    ...
                    <div className="text-sm text-yellow-200/80 leading-relaxed">
                        ...
                        Successful leaderboard placement does not guarantee eligibility
                        unless all requirements above are satisfied. For full rules, see the
                        Rules tab on each theme&apos;s Kaggle page (Sections 6, 7, 8, and 9).
                    </div>
                </div>
            </motion.div>
            ...
            >
                <a
                    href="https://www.kaggle.com/competitions/aisehack-theme-1/rules"
                    target="_blank"
                ...
                <a
                    href="https://www.kaggle.com/competitions/aisehack-theme-2/rules"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-full text-white text-sm font-medium transition-all duration-300 group"
                >
