...
const tracks = [
    ...
    },
    {
        ...
        title: "Theme 2: Polymer Property Prediction",
        desc: "Better batteries, energy storage, materials and drugs all depend on the right set of polymers. Enable this by developing physics / operator based deep learning models for polymer property prediction.",
