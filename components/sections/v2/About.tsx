...
import { Satellite, Atom, Users, Leaf } from "lucide-react";
...
const features = [
    ...
    },
    {
        ...
        desc: "Finalists head to an intensive offline finale, connecting with top researchers, founders and industry pioneers.",
    },
    {
        icon: Atom,
        ...
        desc: "Battle it out on the world’s most renowned data science platform. Registered participants get exclusive private competition invites.",
    },
    {
        icon: Leaf,
        ...
        desc: "Contribute to the national vision of a self-reliant, technologically advanced India by pushing the frontier of AI for Science.",
    },
];
    ...
    return (
        <section id="about" className="relative py-32 px-4 container mx-auto z-10">
            ...
            <div className="text-center mb-20 relative">
                ...
                >
                    <p className="mb-6">
                        The Anusandhan National Research Foundation (ANRF) invites you to AISEHack, India’s
                        premier research hackathon at the intersection of Artificial Intelligence, Science,
                        and Engineering. This isn’t just a coding competition; it’s a mission to safeguard
                        our future.
                    </p>
                    <p className="mb-6">
                    ...
                    <p>
                        ...
                        foundation models, predictive modeling or deep neural operators, AISEHack provides
                        the platform, the data, and the community to make your mark. This hackathon is in
                        coordination with <b>Galaxeye</b> and <b>IIT Madras</b>.
                    </p>
                </motion.div>
            </div>
